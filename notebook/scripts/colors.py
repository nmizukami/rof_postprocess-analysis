...
# create colormaps
# ---------------
cmap11 = LinearSegmentedColormap.from_list(
    "custom blue",
    [
        (0, "xkcd:red"),
        (0.05, "xkcd:orange"),
...
cmap12 = LinearSegmentedColormap.from_list(
    "custom blue",
    [
...
cmap12.set_over("xkcd:dark blue")
...
cmap_diff = LinearSegmentedColormap.from_list(
    "custom 1",
    [(0, "xkcd:red"), (0.50, "xkcd:light grey"), (1, "xkcd:blue")],
    N=250,
)

cmap_swe_diff = LinearSegmentedColormap.from_list(
    "custom 2",
    [(0, "xkcd:red"), (0.50, "xkcd:pale salmon"), (1, "xkcd:light grey")],
    N=250,
)
...
cmap_centroid_diff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (50 / 60, "xkcd:white"), (1.0, "xkcd:blue")],
    N=255,
)
...
cmap_max_day_diff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (60 / 80, "xkcd:white"), (1.0, "xkcd:blue")],
    N=255,
)
...
cmap_min_day_diff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (50 / 150, "xkcd:white"), (1.0, "xkcd:blue")],
    N=255,
)
...
# cms
cmap_max_flow_diff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (100 / 1600, "xkcd:white"), (1.0, "xkcd:blue")],
    N=255,
)
...
# percent diff
cmap_max_flow_pdiff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (20 / 70, "xkcd:white"), (1.0, "xkcd:blue")],
    N=255,
)
...
cmap_min_flow_diff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (20 / 520, "xkcd:white"), (1.0, "xkcd:blue")],
    N=255,
)
...
cmap_freq_high_q_diff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (0.5, "xkcd:white"), (1.0, "xkcd:blue")],
    N=10,
)
...
cmap_freq_high_dur_diff = LinearSegmentedColormap.from_list(
    "custom1",
    [(0.0, "xkcd:red"), (10 / 20, "xkcd:white"), (1.0, "xkcd:blue")],
    N=255,
)
